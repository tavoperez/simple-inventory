...
<div class="container pb-6 pt-6">
	...
	<form action="./php/user_save.php" method="POST" autocomplete="off" class="form">
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Nombres</label>
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Apellidos</label>
				  	<input class="input" type="text" name="lastname" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" maxlength="40" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Repetir clave</label>
				  	<input class="input" type="password" name="repeat_password" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100" required >
				</div>
		  	</div>
		</div>
